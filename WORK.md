...
- [ ] (TODO) **Truncated task titles** — logs show mangled titles ("#170 ,666 gallons", "#156 't the customers"): leading characters are being stripped. Fix task_title extraction in ingestion/classifier. mainly: app/classifier.py / app/ingest.py  branch: —
